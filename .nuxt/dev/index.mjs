...
import { getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getRequestHost, getRequestProtocol, defineEventHandler, setHeader, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://D:/vuep/trip-inn/node_modules/h3/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, parseURL, withLeadingSlash, withoutTrailingSlash, withBase, withoutBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, getQuery, joinRelativeURL } from 'file://D:/vuep/trip-inn/node_modules/ufo/dist/index.mjs';
import destr from 'file://D:/vuep/trip-inn/node_modules/destr/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/vuep/trip-inn/node_modules/unhead/dist/server.mjs';
import * as compilerDom_cjs from 'file://D:/vuep/trip-inn/node_modules/@vue/compiler-dom/dist/compiler-dom.cjs.js';
import * as runtimeDom_cjs from 'file://D:/vuep/trip-inn/node_modules/@vue/runtime-dom/dist/runtime-dom.cjs.js';
import * as shared_cjs from 'file://D:/vuep/trip-inn/node_modules/@vue/shared/dist/shared.cjs.js';
import { walkResolver } from 'file://D:/vuep/trip-inn/node_modules/unhead/dist/utils.mjs';
import { klona } from 'file://D:/vuep/trip-inn/node_modules/klona/dist/index.mjs';
import defu$1, { defu, createDefu, defuFn } from 'file://D:/vuep/trip-inn/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/vuep/trip-inn/node_modules/scule/dist/index.mjs';
import { renderToString } from 'file://D:/vuep/trip-inn/node_modules/@vue/server-renderer/dist/server-renderer.cjs.js';
import { stringify, uneval } from 'file://D:/vuep/trip-inn/node_modules/devalue/index.js';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/vuep/trip-inn/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/vuep/trip-inn/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/vuep/trip-inn/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/vuep/trip-inn/node_modules/node-mock-http/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file://D:/vuep/trip-inn/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/vuep/trip-inn/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/vuep/trip-inn/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/vuep/trip-inn/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/vuep/trip-inn/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/vuep/trip-inn/node_modules/errx/dist/index.js';
import devalue from 'file://D:/vuep/trip-inn/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/vuep/trip-inn/node_modules/radix3/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/vuep/trip-inn/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/vuep/trip-inn/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/vuep/trip-inn/node_modules/ohash/dist/index.mjs';
...
const _GGwpbxsUNCmrSMxnB37nwB_V2OGXSpmLiBquorB74 = (function(nitro) {
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(compilerDom_cjs);

const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(runtimeDom_cjs);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(shared_cjs);
...
const rootDir = "D:/vuep/trip-inn";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"用景點找尋附近合適的旅宿，或是用住宿地點查看附近有哪些知名景點。"},{"name":"robots","content":"max-image-preview:large"},{"property":"og:title","content":"旅遊小站"},{"property":"og:description","content":"用景點找尋附近合適的旅宿，或是用住宿地點查看附近有哪些知名景點。"},{"property":"og:image","content":"https://cjzopen.github.io/trip-inn/images/og-image.jpg"},{"property":"og:type","content":"website"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"旅遊小站"},{"name":"twitter:description","content":"用景點找尋附近合適的旅宿，或是用住宿地點查看附近有哪些知名景點。"},{"name":"twitter:image","content":"https://cjzopen.github.io/trip-inn/images/og-image.jpg"},{"name":"twitter:site","content":"@cjzopen"},{"name":"twitter:creator","content":"@cjzopen"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@400..700&display=swap"},{"rel":"icon","type":"image/x-icon","href":"https://cjzopen.github.io/trip-inn/favicon.ico"}],"style":[{"children":"\n          :root{ --main-color:#345678;}\n          "}],"script":[{"src":"https://www.googletagmanager.com/gtag/js?id=G-DJDQTXG7GS","async":true},{"children":"\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n            gtag('config', 'G-DJDQTXG7GS');\n          "}],"noscript":[{"children":"此網頁需要支援 JavaScript 才能正確運行，請先至你的瀏覽器設定中開啟 JavaScript。"}],"htmlAttrs":{"lang":"zh-Hant-TW"},"viewport":"width=device-width, initial-scale=1","title":"旅遊小站","charset":"utf-8"};
...
const devReducers = {
  VNode: (data) => vueExports.isVNode(data) ? { type: data.type, props: data.props } : void 0,
  URL: (data) => data instanceof URL ? data.toString() : void 0
};
const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _KYaJXAygmS9dO4IsKWMeerxsq8Fq9bSiUyFPnR5mCc = (nitroApp) => {
...
const _pyzWtgGupCvDGPwBRWbmIAiWNCbqUggqYaJUzIsKnS8 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _GGwpbxsUNCmrSMxnB37nwB_V2OGXSpmLiBquorB74,
_KYaJXAygmS9dO4IsKWMeerxsq8Fq9bSiUyFPnR5mCc,
_pyzWtgGupCvDGPwBRWbmIAiWNCbqUggqYaJUzIsKnS8
];
...
const _Dcl9kA = defineEventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _llS5lc = defineEventHandler(async (e) => {
...
const _iMuYda = defineEventHandler(async (e) => {
...
const serverAssets = [{"baseName":"server","dir":"D:/vuep/trip-inn/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/vuep/trip-inn","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/vuep/trip-inn/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/vuep/trip-inn/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/vuep/trip-inn/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/vuep/trip-inn/.data/kv"}));
...
const _HOM9wh = defineEventHandler(async (e) => {
...
const _lazy_3_5LEs = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_3_5LEs, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Dcl9kA, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _llS5lc, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _iMuYda, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _HOM9wh, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3_5LEs, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/vuep/trip-inn/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/vuep/trip-inn/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
