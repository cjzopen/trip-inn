...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function initializeMap(lat, lon) {
      if (!L) {
        L = await import('file://D:/vuep/trip-inn/node_modules/leaflet/dist/leaflet-src.js').then((module) => module.default);
      }
      {
        await import('file://D:/vuep/trip-inn/node_modules/leaflet.markercluster/dist/leaflet.markercluster-src.js');
      }
      if (map) {
        map.remove();
      }
